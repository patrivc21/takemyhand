...
router.put('/updatePaciente', [pacientes_controller_1.default.updatePaciente]);
router.post('/deletePacientes', [pacientes_controller_1.default.deletePacientesController]);
