    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, typeorm_1.DB.getRepository(ChatPrivado_1.ChatPrivado).save(datos)];
            case 1:
                res = _a.sent();
...
var getOneChat = function (id_emisor, id_receptor) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.DB.getRepository(ChatPrivado_1.ChatPrivado).find({
                    where: [
