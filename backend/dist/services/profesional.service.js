    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, typeorm_1.DB.getRepository(RespuestaProfesionales_1.RespuestaHiloProfesionales).save(datos)];
            case 1:
                res = _a.sent();
                console.log(res);
                return [2 /*return*/, res];
...
var getRespuestas = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.DB.getRepository(RespuestaProfesionales_1.RespuestaHiloProfesionales)
