...
exports.initOrm = exports.DB = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, exports.DB.initialize()];
            case 1:
                _a.sent();
                console.log("[orm]: ORM initialized ".concat(config_1.default.db.host, ":").concat(config_1.default.db.port));
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
