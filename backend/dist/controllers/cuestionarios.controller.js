...
exports.getOpnePlanC = exports.addPlanSeguridadC = exports.cuestionarioPlutchik = exports.cuestionarioProbabilidadEnDepresion = void 0;
...
//     res.json(resp); 
// }
var addPlanSeguridadC = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var resp, nombre_archivo, saveFiles, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                resp = new RespGeneric_1.default();
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, cuestionarios_service_1.addPlanSeguridad)(nombre_archivo)];
            case 2:
                saveFiles = _a.sent();
...
exports.addPlanSeguridadC = addPlanSeguridadC;
var getOpnePlanC = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var resp, body, plan, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                resp = new RespGeneric_1.default();
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                body = req.body;
                return [4 /*yield*/, (0, cuestionarios_service_1.getOnePlan)(body.id)];
            case 2:
                plan = _a.sent();
                resp.data = { plan: plan };
                resp.cod = 200;
...
exports.getOpnePlanC = getOpnePlanC;
exports.default = { cuestionarioProbabilidadEnDepresion: exports.cuestionarioProbabilidadEnDepresion, cuestionarioPlutchik: exports.cuestionarioPlutchik, addPlanSeguridadC: exports.addPlanSeguridadC, getOpnePlanC: exports.getOpnePlanC };
